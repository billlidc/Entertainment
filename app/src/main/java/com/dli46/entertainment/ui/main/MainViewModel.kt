...
import com.dli46.entertainment.bored.BoredApi
import com.dli46.entertainment.bored.BoredRepository
import com.dli46.entertainment.bored.BoredResponse
...
//    var option = ""
    ...
    var selection: LiveData<Int> = _selection
    ...
    var option: LiveData<String> = _option
    ...
    fun fetchActivityRandom() {
        val request: Call<BoredResponse> = boredApi.fetchActivityRandom(
        )
